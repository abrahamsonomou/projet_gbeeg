...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 20:05:09 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('assets-admin/img/favicons/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('assets-admin/img/favicons/favicon-16x16.png') }}">
...
<body>
    ...
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            @include('admin.externes.menu')

            @include('admin.externes.navbar')

            <div class="content">

                @include('admin.externes.search')
        ...
        <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src="{{ asset('assets-admin/img/icons/left-arrow-from-left.svg') }}" width="20"
                        alt="" />
                    <div class="flex-1">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src="{{ asset('assets-admin/img/icons/arrows-h.svg') }}" width="20" alt="" />
                    <div class="flex-1">
            ...
            <hr />
            <div class="d-flex align-items-start"><img class="me-2"
                    src="{{ asset('assets-admin/img/icons/paragraph.svg') }}" width="20" alt="" />
                <div class="flex-1">
                ...
                <div class="row gx-2">
                    <div class="col-6"><input class="btn-check" id="navbar-style-transparent" type="radio"
                            ...
                            class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img
                                ...
                                src="{{ asset('assets-admin/img/generic/default.png') }}" alt="" /><span
                    ...
                    <div class="col-6"><input class="btn-check" id="navbar-style-inverted" type="radio"
                            ...
                            class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img
                                class="img-fluid img-prototype"
                                src="{{ asset('assets-admin/img/generic/inverted.png') }}" alt="" /><span
                    ...
                    <div class="col-6"><input class="btn-check" id="navbar-style-card" type="radio"
                            ...
                            class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
                                class="img-fluid img-prototype"
                                src="{{ asset('assets-admin/img/generic/card.png') }}" alt="" /><span
                    ...
                    <div class="col-6"><input class="btn-check" id="navbar-style-vibrant" type="radio"
                            ...
                            class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
                                class="img-fluid img-prototype"
                                src="{{ asset('assets-admin/img/generic/vibrant.png') }}" alt="" /><span
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 20:06:23 GMT -->
