                ...
                <div class="dropdown-menu dropdown-menu-card border-0 mt-0" aria-labelledby="apps">
                    <div class="card navbar-card-app shadow-none dark__bg-1000">
                        <div class="card-body scrollbar max-h-dropdown"><img class="img-dropdown"
                                src="{{ asset('assets-admin/img/icons/spot-illustrations/authentication-corner.png') }}"
                                width="130" alt="" />
                            <div class="row">
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                                    ...
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-2xl me-3">
                                            <img class="rounded-circle"
                                                src="{{ asset('assets-admin/img/team/1-thumb.png') }}"
                                                alt="" />
                                        </div>
                                    </div>
                            ...
                            <div class="list-group-item">
                                <a class="notification notification-flush" href="#!">
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-2xl me-3">
                                            <img class="rounded-circle"
                                                src="{{ asset('assets-admin/img/icons/weather-sm.jpg') }}"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="notification-body">
                                ...
                                <a class="border-bottom-0 notification-unread  notification notification-flush"
                                    ...
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-xl me-3">
                                            <img class="rounded-circle"
                                                src="{{ asset('assets-admin/img/logos/oxford.png') }}"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="notification-body">
                            ...
                            <div class="list-group-item">
                                <a class="border-bottom-0 notification notification-flush"
                                    ...
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-xl me-3">
                                            <img class="rounded-circle"
                                                src="{{ asset('assets-admin/img/team/10.jpg') }}"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="notification-body">
        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser"
                ...
                <div class="avatar avatar-xl">
                    <img class="rounded-circle" src="{{ asset('assets-admin/img/team/3-thumb.png') }}"
                        alt="" />
                </div>
            </a>
